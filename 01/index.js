// The fs module in Node.js stands for "File System" and provides functions for interacting with the file 
// system on your computer.

//It allows you to perform various operations such as reading from files, writing to files, manipulating 
// directories, and more. 

//  Node.js, require() is a built-in function used to load modules (files containing JavaScript code) into 
// your application.

//  When you call require() and pass a module name or path as an argument, Node.js searches for the specified 
// module in the following locations:


const fs = require("fs")

// Here fs is not need to bring it is in-built inside node js
// It still a package but it shifted with node js
